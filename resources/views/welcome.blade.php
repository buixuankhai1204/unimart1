            ...
            <div class="section" id="support-wp">
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            <div class="thumb">
                                <img src="{{url('public/upload/icon-1.png',)}}">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="{{url('public/upload/icon-2.png',)}}">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="{{url('public/upload/icon-3.png',)}}">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="{{url('public/upload/icon-4.png',)}}">
                            </div>
                        ...
                        <li>
                            <div class="thumb">
                                <img src="{{url('public/upload/icon-5.png',)}}">
                            </div>
