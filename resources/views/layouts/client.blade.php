...
<head>
    ...
    <link href="{{asset('public/style1.css')}}" rel="stylesheet" type="text/css" />
...
$categories = Category::whereNull('category_id')
            ...
            ->get();
$product = adminProduct::all()->random(5);
...
?>
    <div id="site">
        <div id="container">
            <div id="header-wp">
                    ...
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    <a href="{{asset('product')}}" title="">Sản phẩm</a>
                                </li>
                                <li>
                                    <a href="{{asset('post')}}" title="">Blog</a>
                                </li>
                                <li>
                                    <a href="{{asset('about')}}" title="">Giới thiệu</a>
                                </li>
                                <li>
                ...
                <div id="head-body" class="clearfix">
                    <div class="wp-inner">
                        <a href="?page=home" title="" id="logo" class="fl-left"><img src="{{asset('public/upload/logo.png')}}" /></a>
                        ...
                        <div id="action-wp" class="fl-right">
                            ...
                            <a href="?page=cart" title="giỏ hàng" id="cart-respon-wp" class="fl-right">
                                <i href="" class="fa fa-shopping-cart" aria-hidden="true"></i>
                                <span id="num">2</span>
                            </a>
                            <div id="cart-wp" class="fl-right">
                                <div id="btn-cart">
                                    <a href="{{url('cart')}}" class="fa fa-shopping-cart" aria-hidden="true"></a>
                                ...
                                <div id="dropdown">
                                    ...
                                    @foreach(cart::content() as $item)
                                        <li class="clearfix">
                                            <a href="{{route('product.detail',$item->id)}}" title="" class="thumb fl-left">
                                                <img src="{{url('public/upload',$item->options->images)}}" alt="">
                                            </a>
                                            <div class="info fl-right">
                                                <a href="{{route('product.detail',$item->id)}}" title="" class="product-name py-2">{{$item->name}}</a>
                                    ...
                                    <div class="total-price clearfix">
                                        ...
                                        <p class="price fl-right">{{$item->total()}}</p>
                                    </div>
                                    @endif
            ...
            <div class="section" id="category-product-wp">
                <div class="section-head">
                    ...
                    @foreach ($categories as $category)
                        <li>
                            <a href="{{route('product.category',$category->id)}}" title="">{{ $category->name }}</a>
                            <ul class="sub-menu pl-5">
                                @foreach ($category->childrenCategories as $childCategory)
                               <a href="{{route('product.category',$childCategory->id)}}">@include('child_category', ['child_category' => $childCategory])</a> 
                                @endforeach
            ...
            <div class="section" id="selling-wp">
                ...
                <div class="section-detail">
                    ...
                    @foreach($product as $item)
                        <li class="clearfix">
                            <a href="{{route('product.detail',$item->id)}}" title="" class="thumb fl-left">
                                <img src="{{url('public/upload',$item->product_thumb)}}" alt="">
                            </a>
                            <div class="info fl-right">
        ...
        <div id="btn-top"><img src="{{asset('public/upload/logo.png')}}" alt="" /></div>
        <div id="fb-root"></div>
        <script>
            (function(d, s, id) {
