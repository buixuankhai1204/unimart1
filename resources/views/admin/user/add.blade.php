        ...
        <div class="card-body">
            <form action="{{asset('admin/user/store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('name') is-danger @enderror" type="text" name="name" id="name">
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input class="form-control @error('password') is-danger @enderror" type="text" name="email" id="email">
                    @error('email')
