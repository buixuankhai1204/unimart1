        ...
        <div class="card-body">
            <form action="{{route('product.update',$product->id)}}" method="POST">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('product_name') is-danger @enderror" type="text" name="product_name" id="product_name" value="{{$product->product_name}}">
                            @error('product_name')
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('product_price') is-danger @enderror" type="text" name="product_price" id="product_price" value="{{$product->product_price}}">
                            @error('product_price')
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea name="product_configuration" class="form-control @error('product_configuration') is-danger @enderror" id="intro" cols="30" rows="5">{{$product->product_configuration}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="product_content" class="form-control @error('product_content') is-danger @enderror" id="intro" cols="30" rows="5">{{$product->product_content}}</textarea>
